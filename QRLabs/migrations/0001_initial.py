    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isDynamic', models.BooleanField(max_length=250, null=True)),
                ('firstSet', models.BooleanField(max_length=250, null=True)),
                ('qrcode', models.CharField(max_length=250, null=True)),
                ('scans', models.IntegerField(max_length=250, null=True)),
                ...
                ('gradient', models.BooleanField(null=True)),
                ...
                ('no_logo_bg', models.BooleanField(null=True)),
                ('transparent_code', models.BooleanField(null=True)),
